define(
    ...
    function (_, Utils) {
         ...
         */
        Map.prototype = {
            getStatesObject: function (lat, lng) {
             ...
             * @returns {address}
             */
            getClosestCity: function (lat, lng) {
                // Prepare params
                lat = parseFloat(lat);
                lng = parseFloat(lng);
             ...
             * @private
             */
            _getUtmostCity: function (sortFunction) {
